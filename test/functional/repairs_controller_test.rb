...
class RepairsControllerTest < ActionController::TestCase
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post :create, repair: { car_id: @repair.car_id, cost: @repair.cost, date: @repair.date, mileage: @repair.mileage, shop: @repair.shop, work_done: @repair.work_done }
    end
  ...
  test "should update repair" do
    put :update, id: @repair, repair: { car_id: @repair.car_id, cost: @repair.cost, date: @repair.date, mileage: @repair.mileage, shop: @repair.shop, work_done: @repair.work_done }
    assert_redirected_to repair_path(assigns(:repair))
  end
